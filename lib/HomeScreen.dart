...
import 'package:musicapp/Section_header.dart';
import 'package:musicapp/playlist_card.dart';
import 'package:musicapp/playlist_model.dart';
import 'package:musicapp/song_card.dart';
                  ...
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: ((context, index) {
                          return playlist_card(playlist: playlists[index]);
                        })),
                  ],
                ),
              ),
    ...
    return BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.favorite_outline_sharp), label: 'Favorite'),
          BottomNavigationBarItem(
